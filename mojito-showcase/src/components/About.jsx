...
useGSAP(()=>{
    ...
    const scrollTimeline = gsap.timeline({
        scrollTrigger:{
            trigger: '#about',
            start: 'top center'  //top section reaches the centre
        }
    })
    ...
    .from('.top-grid div, .bottom-grid div', {
        ...
        ease: 'power1.inOut',
        stagger: 0.04
    }, '-=0.5')  //it will make animation start 0.5s before the previous one ends
})
      ...
      <div className="mb-16 md:px-0 px-5">
        <div className="content">
            <div className="md:col-span-8">
                ...
                <h2>Where every detail matters <span className='text-white'>-</span>from muddle og garnish.</h2>
            </div>
